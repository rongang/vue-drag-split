<template>
	<h2>
		<a
			href="https://github.com/rongang/vue-drag-split/blob/master/src/demo/customer.vue"
			target="_blank"
	...
	>
		...
		<template #AddBtn>
			<div class="add_btn_cus" style="height: 26px; line-height: 26px" @click="createNewWindow">
				+
			</div>
		</template>
		...
		<template #TabActions>
			<button @click="cusClick" style="padding: 3px 10px; margin: 0">自定义按钮</button>
		</template>
